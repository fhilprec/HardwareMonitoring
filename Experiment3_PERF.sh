...
echo "Average values after $iterations iterations for the Raw Device and then for the Monitor"
echo "   cycles,   instructions, L1-misses, LLC-misses, branch-misses,   task-clock, scale,  IPC, CPUs,  GHz"
echo "$avg_cycles, $avg_instructions, $avg_L1_misses, $avg_LLC_misses, $avg_branch_misses, $avg_task_clock, $avg_scale, $avg_IPC, $avg_CPUs, $avg_GHz"
...
echo "$avg_cycles, $avg_instructions, $avg_L1_misses, $avg_LLC_misses, $avg_branch_misses, $avg_task_clock"
